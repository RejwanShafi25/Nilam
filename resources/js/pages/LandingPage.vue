            ...
            <div class="relative container">
                ...
                <section class="relative flex h-[calc(100svh-3.5rem)] w-full flex-col items-center justify-center text-center">
                    ...
                    <div class="relative z-10 mx-auto max-w-3xl">
                        <h1 class="text-4xl font-bold tracking-tight text-balance text-white sm:text-5xl md:text-6xl">The Art of the Auction</h1>
                        <p class="mt-6 text-lg text-balance text-gray-300 md:text-xl">
                            Discover, bid, and win rare and exclusive items from around the world.
                        </p>
                        <div class="mt-10 flex items-center justify-center gap-4">
                            <Link :href="route('dashboard')">
                                <Button size="lg" variant="outline">Browse Auctions</Button>
                            </Link>
                        </div>
                    </div>
                </section>
